...
export default function AboutPage() {
    ...
    return (
        <div className=" bg-gray-900 text-white">
            ...
            <div className="min-h-screen">
                ...
                <section className="relative pt-20 sm:pt-24 md:pt-32 min-h-screen pb-10 sm:pb-16 md:pb-20 px-4 sm:px-6 [background:linear-gradient(to_bottom,#A0D1FF_1%,#fffff1_100%)]">
                    ...
                    <div className="max-w-7xl mx-auto text-center">
                        ...
                        {/* Company Images Grid */}
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-12 md:mt-16">
                            <div className="bg-white/10 backdrop-blur-md md:col-span-2 rounded-2xl hover:bg-white/20 transition">
                                <Image src={Big1} alt='' />
                            </div>
            ...
            <section className="py-10 sm:py-16 md:py-20 px-4 sm:px-6 bg-white text-black">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
                        <div className='lg:pr-10'>
                            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 md:mb-8">Empowering the Future with Smarter Energy Solutions</h2>
                            <div>
                                ...
                                <p className="text-base sm:text-lg md:text-xl leading-relaxed font-medium mb-4 sm:mb-6">
                            ...
                            <div className="grid grid-cols-1 gap-6 mb-8 pt-6">
                                {statistics.map((stat, index) => (
                                    <div key={index} className="text-center">
                                        <div
                                            className={`text-6xl font-bold bg-clip-text text-transparent mb-2 transition-all duration-500 ${index === activeStatIndex ? 'opacity-100 scale-110' : 'opacity-60 scale-100'
                                                }`}
                                            style={{
                                        ...
                                        <div className={`text-black text-lg transition-all duration-500 ${index === activeStatIndex ? 'opacity-100 font-semibold' : 'opacity-60'
                                            }`}>
                                            {stat.label}
                                        </div>
                                    </div>
            ...
            <div className="relative w-full py-16 sm:py-20 md:py-30 overflow-hidden">
                {/* Background Image with Overlay */}
                <div
                    className="absolute inset-0 bg-cover bg-center"

                >
                    <Image alt='' src={BG} className='h-full w-full object-cover' />
                    {/* Dark overlay */}
                    <div className="absolute inset-0 bg-black/70"></div>
                </div>

                {/* Content */}
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-10 md:py-12 h-full flex flex-col justify-center">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6">
                        R&D Innovation
                    </h2>

                    <p className="text-white/90 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl max-w-5xl leading-relaxed mb-6 sm:mb-8">
                    ...
                    <button className="flex items-center gap-2 text-white text-base sm:text-lg md:text-xl lg:text-2xl hover:text-cyan-300 transition-colors font-medium group w-fit">
                        <span className="flex items-center bg-gradient-to-r from-[#2D8DFD] to-[#3DE15C] text-white justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full transition-colors">
                            <svg
            ...
            <section className="py-10 sm:py-16 md:py-20 px-4 sm:px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 sm:mb-12 md:mb-16 text-black">Company History</h2>

                    {/* Timeline Cards - Show 3 visible cards */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12 max-w-6xl mx-auto">
                        {[0, 1, 2].map((offset) => {
                            const index = (activeIndex + offset) % companyHistory.length;
                            const item = companyHistory[index];
                            return (
                                <div key={index} className="text-left">
                                    <h3 className={`text-2xl sm:text-3xl md:text-4xl font-bold bg-clip-text text-transparent mb-2`}
                                        style={{
            ...
            <section className="py-10 sm:py-16 md:py-20 px-4 sm:px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-black text-center mb-2 sm:mb-4">Our Advantages</h2>
                    <p className="text-base sm:text-lg md:text-xl text-center text-black mb-8 sm:mb-12 md:mb-16 px-4">Driving Growth that Powers Global Sustainability</p>

                    <div className="relative">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                            {getVisibleAdvantages().map((advantage, index) => (
                                <div key={index} className="group">
                                    <div className="relative overflow-hidden rounded-2xl p-6 sm:p-8 h-64 sm:h-72 md:h-80 hover:transform hover:scale-105 transition duration-300">
                                        {/* Background Image */}
                                        ...
                                        <div className="relative z-10 h-full flex flex-col justify-end">
                                            ...
                                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 text-white">{advantage.title}</h3>
                                            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">{advantage.description}</p>
                                        </div>
            ...
            {/* Partners Section */}
            <section className="py-10 sm:py-16 md:py-20 px-4 sm:px-6 bg-gradient-to-b from-[#3DE15C] to-[#2D8DFD]">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold mb-8 sm:mb-10 md:mb-12 px-4">Dyness secures billions in Series B & C funding accelerating innovation for a smarter energy future.</h2>

                    {/* Partner logos carousel */}
                    <div className="flex justify-center items-center gap-4 sm:gap-6 md:gap-8 overflow-hidden flex-wrap">
                        {getVisiblePartners().map((logo, index) => (
                            <div
                                key={index}
                                className="rounded-xl p-3 sm:p-4 md:p-6 flex items-center justify-center hover:shadow-lg transition-all duration-300 w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28"
                            >
                                <Image
                                    src={logo}
                                    alt={`Partner ${index + 1}`}
