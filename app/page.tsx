...
import Home1 from "../app/Generated Image October 24, 2025 - 1_37PM 2.png"
...
import Home2 from "../app/Group 15.png"
...
export default function ZibboWebsite() {
    ...
    // Cycle through hero slides every 5 seconds
    useEffect(() => {
        const interval = setInterval(() => {
    ...
    return (
        ...
        <div className="min-h-screen bg-white text-white">
            ...
            <div className="relative w-full h-screen overflow-hidden">
                ...
                <div className={`absolute inset-0 transition-opacity duration-1000 ${currentSlide === 0 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
                    <section className="relative min-h-screen overflow-hidden">
                        <div className="absolute inset-0 z-0">
                            <Image alt='Powering Pakistan' src={Home1} className="w-full h-full object-cover" />
                            <div className="absolute inset-0"></div>
                        </div>

                        <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto pt-24 sm:pt-28 md:pt-32">
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4">
                                POWERING PAKISTAN WITH SMART
                            </h1>
                            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#3DE15C] mb-4 sm:mb-6">
                                LITHIUM ENERGY SOLUTIONS
                            </h2>
                            <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-6 sm:mb-8 text-white max-w-3xl mx-auto">
                                Smart, Safe, And Reliable Lithium Battery Solutions For Homes And Businesses. Click Below To See How Zibbo Is Driving The Future Of Clean Energy.
                            </p>
                            <button className="bg-gradient-to-r from-[#2D8DFD] to-[#3DE15C] text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full text-base sm:text-lg md:text-xl font-semibold transition transform hover:scale-105">
                                Discover Products
                            </button>
                        </div>
                    </section>
                            ...
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full">
                                <div className="max-w-2xl">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                                        <button className="bg-white/0.01 backdrop-blur-sm text-white px-6 sm:px-8 py-2 sm:py-3 rounded-xl font-medium border border-white/30 hover:bg-white/20 transition">
                                            Learn More
                                        </button>
                                        <button className="bg-white text-black backdrop-blur-sm px-6 sm:px-8 py-2 sm:py-3 rounded-xl font-medium border border-white/30 hover:bg-white/20 transition">
                                            Shop Now
                                        </button>
                                    </div>
                                </div>
                ...
                <div className="hidden sm:flex absolute right-3 sm:right-6 top-1/2 -translate-y-1/2 z-30 flex-col justify-center items-center border-2 border-white rounded-lg py-3 sm:py-4 px-1 space-y-3 sm:space-y-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 50 50" fill="none" className="sm:w-[50px] sm:h-[50px]">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 36 36" fill="none" className="sm:w-[36px] sm:h-[36px]">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 44 44" fill="none" className="sm:w-[44px] sm:h-[44px]">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 47 47" fill="none" className="sm:w-[47px] sm:h-[47px]">
                ...
                {/* Slide Indicators */}
                <div className="absolute bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2 z-30 flex space-x-2 sm:space-x-3">
                    <button
                        onClick={() => setCurrentSlide(0)}
                        className={`w-3 h-3 rounded-full transition-all ${currentSlide === 0 ? 'bg-white w-8' : 'bg-white/50'}`}
                        aria-label="Slide 1"
                    />
                    <button
                        onClick={() => setCurrentSlide(1)}
                        className={`w-3 h-3 rounded-full transition-all ${currentSlide === 1 ? 'bg-white w-8' : 'bg-white/50'}`}
                        aria-label="Slide 2"
                    />
                </div>
            </div>
            ...
            {/* About Section */}
            <section className="relative min-h-screen flex items-center justify-center py-12 sm:py-16 md:py-20 px-4 sm:px-6">
                ...
                <div className="relative z-10 max-w-6xl mx-auto">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-8 sm:mb-10 md:mb-12">About ZIBBO</h2>
                    <p className="text-center text-sm sm:text-base text-gray-300 max-w-4xl mx-auto mb-8 sm:mb-10 md:mb-12 leading-relaxed px-4">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 mb-8 sm:mb-12">
                        ...
                        <div className="lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div className="text-start">
                                <div className="text-4xl sm:text-5xl md:text-6xl font-bold bg-clip-text text-transparent mb-2"
                                    style={{
                                        backgroundImage: 'linear-gradient(90deg, #2D8DFD 15%, #3DE15C 75%)'
                                    }}> 5GWh+</div>
                                <div className="text-white text-sm sm:text-base">Annual Production Capacity</div>
                            </div>
                            <div className="text-start">
                                <div className="text-4xl sm:text-5xl md:text-6xl font-bold bg-clip-text text-transparent mb-2"
                                    style={{
                                ...
                                <div className="text-white text-sm sm:text-base">Patents & Technological Innovations</div>
                            </div>
                            <div className="text-start">
                                <div className="text-4xl sm:text-5xl md:text-6xl font-bold bg-clip-text text-transparent mb-2"
                                    style={{
                                ...
                                <div className="text-white text-sm sm:text-base">Global Customers Trust Zibbo</div>
                            </div>
                            <div className="text-start">
                                <div className="text-4xl sm:text-5xl md:text-6xl font-bold bg-clip-text text-transparent mb-2"
                                    style={{
                                ...
                                <div className="text-white text-sm sm:text-base">Utility Model Patents</div>
                            </div>
                            <button
                                className="border-2 border-[#3DE15C] w-full sm:w-52 text-white text-[#3DE15C] px-2 py-2 sm:py-1 rounded-full font-semibold transition text-sm sm:text-base">
                                Learn More About Us
                            </button>
            ...
            {/* Solutions Section */}
            <section className="relative flex bg-white items-center justify-center py-12 sm:py-16 md:py-20 px-4 sm:px-6">
                ...
                <div className="absolute inset-0">
                    <Image
                        ...
                        className="w-full h-full object-cover"
                    />
                    <div className="absolute inset-0  z-0 bg-black/10  backdrop-blur-md"></div>
                </div>

                <div className="relative z-10 max-w-6xl mx-auto bg-white/30 px-4 sm:px-8 md:px-12 lg:px-20 py-6 sm:py-8 md:py-10 rounded-2xl">
                    ...
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-12 sm:mb-16 md:mb-24 text-black">
                        Sustainable Tomorrow
                    </h3>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mb-8 sm:mb-12">
                        <div className="relative backdrop-blur-md rounded-3xl p-1 hover:shadow-2xl transition transform hover:scale-105 bg-gradient-to-r from-[#07B4E3] to-[#4CC420]">
                            <div className="bg-white rounded-3xl p-4 sm:p-6 md:p-8 h-full">
                                <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-gray-200 rounded-full mb-3 sm:mb-4 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="55" height="41" viewBox="0 0 55 41" fill="none" className="w-10 h-8 sm:w-12 sm:h-9 md:w-[55px] md:h-[41px]">
                                ...
                                <h4 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 text-[#333333]">Residential Energy Storage Solution</h4>
                        ...
                        <div className="relative backdrop-blur-md rounded-3xl p-1 hover:shadow-2xl transition transform hover:scale-105 bg-gradient-to-r from-[#07B4E3] to-[#4CC420]">
                            <div className="bg-white rounded-3xl p-4 sm:p-6 md:p-8 h-full">
                                <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-gray-200 rounded-full mb-3 sm:mb-4 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="47" height="57" viewBox="0 0 47 57" fill="none" className="w-10 h-12 sm:w-11 sm:h-14 md:w-[47px] md:h-[57px]">
                                ...
                                <h4 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 text-[#333333]">C&I Energy Storage Solution</h4>
                                <p className="text-black text-sm sm:text-base">
            ...
            <section className="relative min-h-screen flex items-center justify-center py-12 sm:py-16 md:py-20 px-4 sm:px-6">
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-10 sm:mb-12 md:mb-16">OUR PRODUCTS</h2>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                        {products.map((product, index) => (
                            <div key={index} className="bg-white rounded-2xl border-2 border-[#3DE15C] overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                                <div className="p-4 sm:p-6">


                                    <div className="w-full h-36 sm:h-40 md:h-48 bg-gray-50 rounded-xl mb-3 sm:mb-4 flex items-center justify-center">
                                        <Image
                                            src={product.image}
                                            alt={product.name}
                                    ...
                                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-black mb-2">{product.name}</h3>
                                    <p className="text-sm sm:text-base text-gray-600 mb-1">{product.capacity}</p>
                                    <p className="text-xs sm:text-sm text-gray-500 mb-3 sm:mb-4">Energy Storage</p>
            ...
            <section className="relative min-h-screen flex items-center justify-center py-12 sm:py-16 md:py-20 px-4 sm:px-6">
                ...
                <div className="relative z-10 max-w-7xl mx-auto text-center">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-10 sm:mb-12 md:mb-16">Global Network</h2>

                    <div className="relative mb-8 sm:mb-10 md:mb-12">
                        {/* World Map Visualization */}
                        <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] flex items-center justify-center rounded-2xl overflow-hidden">
                            <ComposableMap
                            ...
                            <div
                                key={activeLocation}
                                className="absolute bottom-4 sm:bottom-8 right-2 sm:-right-8 transition-all duration-500 animate-fade-in"
                            >
                                <div className="border-2 border-[#3DE15C] shadow-lg shadow-[#3DE15C] rounded-xl p-3 sm:p-4 flex items-center gap-2 sm:gap-3 min-w-[200px] sm:min-w-[280px]">
                                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#3DE15C] rounded-full flex items-center justify-center flex-shrink-0">
                                        <span className="text-xl sm:text-2xl font-bold text-gray-900">{locations[activeLocation].flag}</span>
                                    </div>
                                    <div className="text-left">
                                        <div className="text-white font-bold text-base sm:text-lg">{locations[activeLocation].name}</div>
                                        <div className="text-xs sm:text-sm text-gray-300">{locations[activeLocation].company}</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <p className="text-sm sm:text-base text-gray-300 max-w-4xl mx-auto mb-6 sm:mb-8 leading-relaxed px-4">
                    ...
                    <button className="bg-gradient-to-r from-[#2D8DFD] to-[#3DE15C] text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full text-base sm:text-lg font-semibold transition transform hover:scale-105">
                        Explore Our Network
                    </button>
                </div>
            </section>
            ...
            <section className="relative min-h-screen flex items-center justify-center py-20 px-6">
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    <div className="relative md:flex items-center mb-12 md:mb-48">
                        ...
                        <div className="md:absolute md:-bottom-24 md:left-[40%] md:w-[55%] w-full opacity-80 bg-gradient-to-br from-[#2C8FFD] to-[#5BA8FF] rounded-3xl px-10 py-20 text-white shadow-2xl">
            ...
            <section className=" mt-6">
                ...
                <div className="bg-gradient-to-br from-[#2C8FFD] to-[#1A5597]/10 md:rounded-[48px] p-10 md:p-20 md:relative  max-w-7xl mx-auto">
